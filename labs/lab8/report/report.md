...
$$M_0^1=4.8, \, M_0^2=4.5,\\ p_{cr}=12, \,N=39, q=1\\ \tau_1=19, \, \tau_2=29,\\ \tilde{p_1}=7.9, \, \tilde{p_2}=5.8$$
...
![График мзменения оборотных средств для случая 1](image/lab08_1.png){#fig:001 width=70%}
...
терпит убытки. Динамика роста объемов оборотных средств второй фирмы
остается без изменения: достигнув максимального значения, остается на этом
уровне.


![График мзменения оборотных средств для случая 2](image/lab08_2.png){#fig:002 width=70%}
